...
export class TypeScriptConverter {
    ...
    public static async writeDeviceInterfacesToFileAsync(
        ...
        let tsCode: string =
                await TypeScriptConverter.writeDeviceInterfacesAsync(deviceInterfaces);
     ...
     *
     * @param {DeviceInterface[]} deviceInterfaces  One or more interfaces to write
     * @returns {Promise<string>} TypeScript type-definition code
     */
    public static async writeDeviceInterfacesAsync(
            deviceInterfaces: DeviceInterface[]): Promise<string> {
